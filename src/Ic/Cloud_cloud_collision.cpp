...
void Cloud_cloud_collisionIc<ndim>::Generate(void)
{
  ...
  if (particle_dist == "random") {
    AddRandomSphere(Npart1, rcentre, radius1, r1);
  }
  else if (particle_dist == "cubic_lattice" || particle_dist == "hexagonal_lattice") {
    Nsphere = AddLatticeSphere(Npart1, rcentre, radius1, particle_dist, r1);
  ...
  // Create the sphere depending on the choice of initial particle distribution
  if (particle_dist == "random") {
    AddRandomSphere(Npart2, rcentre, radius2, r2);
    //    for (i=0; i<Npart2; i++){
    //cout << r2[i] << endl;
    //}
  }
  else if (particle_dist == "cubic_lattice" || particle_dist == "hexagonal_lattice") {
    Nsphere = AddLatticeSphere(Npart2, rcentre, radius2, particle_dist, r2);
  ...
  InterpolateVelocityField(Npart1, gridsize, xmin, dxgrid, r1, vfield, v1);
  ...
  // Now interpolate generated field onto particle positions
  InterpolateVelocityField(Npart2, gridsize, xmin, dxgrid, r2, vfield, v2);
