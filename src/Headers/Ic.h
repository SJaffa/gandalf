...
protected:
  ...
  void AddGaussSphere(int, FLOAT *, FLOAT *, FLOAT, RandomNumber *);
  ...
  void Cloud_cloud_collision(void); //New!
...
//=================================================================================================
template <int ndim>
class Cloud_cloud_collisionIc : public Ic<ndim>
{
protected:
  ...
  //using Ic<ndim>::icBox;
  using Ic<ndim>::invndim;
  using Ic<ndim>::sim;// void Cloud_cloud_collision(void); //New!
...
public:
  ...
  Cloud_cloud_collisionIc(Simulation<ndim>* _sim, FLOAT _invndim);
  virtual ~Cloud_cloud_collisionIc() {};
