...
protected:
 public:
  ...
  template<class ParticleSubType>
  NeighbourManager<ndim,ParticleSubType> create_neighbour_manager() {
    return NeighbourManager<ndim,ParticleSubType>(types, kernp->kernrange,*box);
  }
  ...
  ParticleTypeRegister& types;                     ///< Information about particle types
