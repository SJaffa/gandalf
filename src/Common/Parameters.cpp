...
void Parameters::SetDefaultValues(void)
{
  ...
  //Cloud cloud collision parameters                                                                               
  //-----------------------------------------------------------------------------------------------                 
  intparams["Npart1"] = 0;
  intparams["Npart2"] = 0;
  floatparams["impact_param"] = 0.;
  floatparams["relative_vel"] = 0.;
  floatparams["deltax0"] = 0.;
  floatparams["mcloud1"] = 0.;
  floatparams["mcloud2"] = 0.;
  floatparams["radius1"] = 0.;
  floatparams["radius2"] = 0.;
  floatparams["alpha_turb1"] = 1.;
  floatparams["alpha_turb2"] = 1.;
  
  // Radial density profile parameters
  //-----------------------------------------------------------------------------------------------
  
  floatparams["radgrad"] = 0.0;
